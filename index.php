    ...
    <div class="row">
      ...
      <div class="col-lg-4">
        <div class="card_ mb-5 mb-lg-0">
          <div class="card-body">
            <h5 class="card-title text-muted text-uppercase text-center">Marketing WhatsApp</h5>
            <h6 class="card-price text-center">R$ 20<span class="period">/mensal</span></h6>
            <hr>
            <ul class="fa-ul">
              <li><span class="fa-li"><i class="fas fa-check"></i></span>Planilha basic</li>
